...
def setup():
    ...
    strijdKaarten = [["Daag 1 speler uit. De uitgedaagde speler schat hoeveel global warming-termen hij/zij kan opnoemen. De tweede speler zegt of ze dit kunnen overtreffen. Als ze dat kunnen, proberen ze dat. Als dit ze lukt krijgen ze 5 punten richting hun doel."],
    ["Daag 1 speler uit. De uitgedaagde speler schat hoeveel videos met meer dan 2,5 miljard views ze kunnen opnoemen. De tweede speler zegt of ze dit kunnen overtreffen. Als ze dat kunnen, proberen ze dat. Als dit ze lukt krijgen ze 5 punten richting hun doel."],
    ["Daag 1 speler uit. De uitgedaagde speler schat hoeveel instagram-accounts met meer dan 75 miljoen volgers ze kunnen opnoemen. De tweede speler zegt of ze dit kunnen overtreffen. Als ze dat kunnen, proberen ze dat. Als dit ze lukt krijgen ze 5 punten richting hun doel."],
    ["Daag 1 speler uit. De uitgedaagde speler schat hoeveel landen in de top 20 koolstofemissie-landen ze kunnen opnoemen. De tweede speler zegt of ze dit kunnen overtreffen. Als ze dat kunnen, proberen ze dat. Als dit ze lukt krijgen ze 5 punten richting hun doel."],
    ["Daag 1 speler uit. De uitgedaagde speler schat hoeveel woorden met meer dan 15 letters ze kunnen opnoemen. De tweede speler zegt of ze dit kunnen overtreffen. Als ze dat kunnen, proberen ze dat. Als dit ze lukt krijgen ze 5 punten richting hun doel."],
    ["Degene die deze kaart trekt daagt iemand anders uit om te kijken wie er langer op 1 been kan staan. De winnaar krijgt een strijdkaart om later uit te delen."],
    ["Speel steen papier schaar tegen een speler naar keuze. Degene die als eerste 2x wint krijgt een strijdkaart om later uit te delen."],
    ["Alle spelers noemen omstebeurt een bedreigde diersoort op. Wie als laatste nog iets weet krijgt een strijdkaart om later uit te delen."],
    ...
    ["De speler begint met het benoemen van een automerk. Hierna bedenkt de volgende speler een automerk."],
    ...
    ["De speler die deze kaart trekt moet vanaf nu alles met 1 hand doen. Klik op de strijdkaart aan de zijkant om terug te gaan en een kanskaart te trekken"],
    ["Speel een potje duim worstelen tegen de speler die het verste van zijn doel af is."],
    ["Je mag een willekeurige speler uitkiezen die nu een kanskaart moet trekken. Klik op de strijdkaart aan de zijkant"],
    ["Bedenk in 30 seconden minstens 10 groenten."],
    ["Bedenk in 30 seconden minstens 10 jongensnamen."],
    ["Bedenk in 30 seconden minstens 10 meisjesnamen."],
    ["Bedenk in 30 seconden minstens 10 automerken."],
    ["Bedenk in 30 seconden minstens 10 mannelijke filmsterren."],
    ["Bedenk in 30 seconden minstens 10 vrouwelijke filmsterren."],
    ["Daag iemand uit. Iedere speler krijgt 30 sec om een top 3 te vormen over wat in nederland de meeste uitstoot veroorzaakt. Degene die het dichts bij zit qua vormen wint een strijdkaart"],
    ["Speel met al je medespelers Ik ga protesteren op Malieveld en ik neem mee: een variatie op ik ga op reis en ik neem mee waar je manieren noemt om duurzamer te leven."],
    ["Gok wat je gaat gooien met twee dobbelstenen. Als je de juiste soort aantal gooit(bijvoorbeeld 9), verdien je een strijdkaart."]
    ]
